  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested transaction" do
        ...
        transaction.reload
        expect(transaction.amount).to eq(new_attributes[:amount])
        expect(transaction.t_date).to eq(new_attributes[:t_date])
        expect(transaction.t_time.strftime("%H:%M:%S")).to eq(new_attributes[:t_time])
